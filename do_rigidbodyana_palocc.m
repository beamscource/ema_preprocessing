...
%dorig branch
inpath=['palocc' pathchar 'velrep' pathchar];
%outpath=['mat'];
outpath=['finaldata' pathchar 'palocc'];
...
cutfile=['finaldata' pathchar subjectname 'palocc_cut'];
...
%logfile=['palocc_dummystim_log_PL1_adj'];	%specify without the .txt extension 
logfile=mymatin('basicsettings', 'palocc_logfile');
